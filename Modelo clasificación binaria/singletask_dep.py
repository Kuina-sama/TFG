...
def collate_fn(batch):
    ...
    batched_input = {'input_ids':input_ids, 'attention_mask':attention_mask, 'dep_tags': torch.tensor(deps),'label':label}
...
class SingleTaskDep(nn.Module):
    ...
    def forward(self,input_ids = None,attention_mask = None,dep_tags = None,label=None):
