...
class SingleTaskRRNN(nn.Module):
    ...
    def __init__(self, vocab_size, lstm_hidden_dim, emb_dim=20, emb_weights=None, dropout=0.1):
        super().__init__()
...
class SingleTaskRRNN2(nn.Module):
    ...
    def forward(self, input_ids=None, **kwargs):
        ...
        out_emb = self.dropout_layer(self.emb(input_ids))
...
class SingleTaskRRNNDep(nn.Module):
    ...
    def __init__(self, dep_vocab, vocab_size, lstm_hidden_dim, emb_dim=20, emb_weights=None, dropout=0.1):
        super().__init__()
...
# Esta parte tengo qeu revisarla un poco, por ejemplo porqué narices tengo el dropout comentado.
# A mayores, este no me sirve para el w2v por el momento!!
